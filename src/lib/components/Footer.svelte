<!-- Footer -->
<footer class="hidden border-t border-gray-800 px-6 pt-12 pb-6 md:px-12 lg:px-16">
	<div class="container mx-auto">
		<div class="mb-12 grid grid-cols-2 gap-8 md:grid-cols-4">
			<div>
				<h3 class="mb-4 font-bold text-white">Produtos</h3>
				<ul class="space-y-2">
					<li><a href="/" class="text-gray-400 hover:text-white">CoreSync</a></li>
					<li><a href="/" class="text-gray-400 hover:text-white">Bagity</a></li>
			...
			<div>
				<h3 class="mb-4 font-bold text-white">Ventures</h3>
				<ul class="space-y-2">
			...
			<div>
				<h3 class="mb-4 font-bold text-white">Social</h3>
				<ul class="space-y-2">
			...
			<div>
				<h3 class="mb-4 font-bold text-white">Lab</h3>
				<ul class="space-y-2">
		...
		<div class="flex flex-col items-center justify-between md:flex-row">
			...
			<div class="flex items-center">
				<div class="bg-fw-red mr-2 p-2">
					<span class="text-lg font-bold text-white">FW</span>
				</div>
				<span class="text-sm text-red-500">Futurewise Innovation Laboratories</span>
			</div>
		</div>
	</div>
</footer>
